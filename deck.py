...
class Deck:
    ...
    def insert(card_list, card):
        ...
        other_card_index = 0
        # according to rulls in class card and it's __lt__ func we search for the place to put new card with other_card_index
        while other_card_index < len(card_list) and card_list[other_card_index] < card:
            other_card_index += 1
            
            #when such place is foud we insert the new card
            card_list.insert(other_card_index, card)
